...
class Stonithd(ResetMechanism):
    def __init__(self, nodes, sttype = 'external/ssh'):
        ...
        self.lrmd_add_pat    = '/usr/sbin/lrmadmin -A %s stonith ' + sttype + ' NULL hostlist=%s livedangerously=yes'
        self.lrmd_start_pat  = '/usr/sbin/lrmadmin -E %s start 0 0 EVERYTIME'
        self.lrmd_stop_pat   = '/usr/sbin/lrmadmin -E %s stop 0 0 EVERYTIME'
        self.lrmd_del_pat    = '/usr/sbin/lrmadmin -D %s'
